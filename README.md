...
2. **Reflection** – Do LLMs reflect and replicate human discourse patterns embedded in their training data?
...
1. Step 1 – Multi-Run Prompting
   Run the 5 structured prompts on 5 independent sessions.
2. Step 2 – Reflective Synthesis
   Manually copy the text outputs or feed the raw JSON outputs into a separate, unprimed, fresh AI instance (what we call a Reflective Synthesis Agent (RSA)) to analyze the discourse.
3. Step 3 – Meta-Reveal
   Aggregate the findings across systems and runs, surfacing deeper insights about recursion and amplification.
...
⬜ Phase 1 - Step 2 - RSA prototype integrated (Automations in development)<br/>
